...
export abstract class Simulacrum {
    ...
    public logUserReflection(reflection: string) {
        ...
        this.userSensemaking ??={}; 
        this.userSensemaking.reflection = reflection
    }

    public logUserAbstraction(abstraction: string) {
        this.userSensemaking.abstraction = abstraction; 
    }

    public get sensemaking() {
        return this.userSensemaking
    }
}
