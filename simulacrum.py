...
delibs = Deliberation(
    ...
    group='STRIPED',
    state='Texas',
    policy_topic='Out of Kids Hands campaign',
    ideology='conservative',
    lawmaker_name='Rep Jay'
)

delibs_2 = Deliberation(
    username="Stanley",
    group='STRIPED',
    state='Texas',
    policy_topic='Out of Kids Hands campaign',
...
delibs.panel_discussion("Hi!")
delibs.discussion_history
held_obj = delibs.discussion_history
delibs._cached_prompts
delibs._cached_responses
delibs.discussion_history

delibs.panel_discussion("Thanks for meeting with me.")
delibs_2.discussion_history=held_obj
delibs_2.discussion_history

delibs_2.panel_discussion("Do you know my name?")
delibs_2.discussion_history
delibs_2._cached_prompts
delibs_2._cached_responses
results = delibs.panel_discussion("Thanks so much for your interest in our work!")
delibs.discussion_history[1]

delibs.discussion_history

# class SimAgent(Agent, BaseModel): 
#     name: str
#     ideology: str
#     state: str
#     is_chair: bool
...
#     def __init__(self, name, ideology, state, is_chair, policy_topic, **agent_kwargs):
...
#         sample_key = Simulacrum._random_sampler(alpha=3, beta=3)
#         if sample_key < 0.334: 
...
# Hearing(username='Stanley',
#         group='Strategic Training Initiative for the Prevention of Eating Disorders',
#         state='Texas',
#         policy_topic='Out of Kids Hands campaign to restrict the sale of over-the-counter weight-loss supplements',
#         num_agents=4, 
#         agent_ideology_method='random',
#         )