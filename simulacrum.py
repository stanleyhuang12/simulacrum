...
class Simulacrum: 
    ...
    def _manage_conversation_history(self): 
        ...
        for i, dialogue in enumerate(zip(self._cached_prompts, self._cached_responses)): 
            episode = self._log_episodal_memory(i, dialogue)
    ...
    def _retrieve_memory(self, memory_type='long_term'):
        ...
        for episode in discussion_history:
            ...
            transcript_lines.append(f"{self._get_agent_label()}: {episode['lawmaker']}")
...
class Deliberation(Simulacrum): 
    ...
    def _init_virtual_lawmaker(self): 
        ...
        virtual_lawmaker_instructions_templates = { 
                "support": (
                    f"You are a lawmaker in {self.state} and you are {self.ideology}. You are meeting with a constituent to discuss '{self.policy_topic}'. "
                ...
                "disagree_with_caution": (
                    f"You are a lawmaker in {self.state} and you are {self.ideology} meeting with a constituent to discuss '{self.policy_topic}'. "
...
class SimAgent(Agent): 
    def __init__(self, name, ideology, state, is_chair, policy_topic, **kwargs): 
